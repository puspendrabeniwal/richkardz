        ...
        (err, result) => {
          if (!err) {
            res.send({
              ...
              error: {},
              message: res.__(
                "admin.block.block_details_has_been_updated_successfully"
              ),
            });
          } else {
            return res.send({
          ...
          blocks.insertOne(
            ...
            (err, result) => {
              ...
              res.send({
                ...
                result: [],
                message: res.__(
                  "admin.block.block_has_been_added_successfully"
                ),
              });
            }
          );
