...
module.exports = {
	configure: function(router,mongo) {
		...
		require(WEBSITE_MODULES_PATH+"email_template/routes");
		require(WEBSITE_MODULES_PATH+"combo_products/routes");
		require(WEBSITE_MODULES_PATH+"leads/routes");
		require(WEBSITE_MODULES_PATH+"users/routes");
		require(WEBSITE_MODULES_PATH+"gift_pre_design_product/routes");
		require(WEBSITE_MODULES_PATH+"tnt_request/routes");
	}
};
