                ...
                <div className="d-flex flex-wrap flex-sm-nowrap">
                  <div className="me-7 mb-4">
                    <div className="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                      <img
                        src={`${userData?.image_url + userData?.profile_image}`}
                        alt="Profile image"
                      />
                      ...
                      <div className="timeline-item">
                        ...
                        <div className="timeline-content mb-10 mt-n1">
                          <div className="mb-5 pe-3">
                            ...
                            <div className="d-flex align-items-center mt-1 fs-6"></div>
                          </div>
                                ...
                                >
                                  <div className="symbol-group symbol-hover mb-3">
                                    ...
                                    >
                                      ...
                                      >
                                        <span className="symbol-label bg-primary text-inverse-warning fw-bolder">
                                          F
                                        </span>
                                      </div>
                                    </a>
                                    ...
                                    >
                                      ...
                                      >
                                        <span className="symbol-label bg-success text-inverse-primary fw-bolder">
                                          W
                                        </span>
                                      </div>
                                    </a>
                                    ...
                                    <a
                                      href="https://www.youtube.com/user/your-channel"
                                      target="_blank"
                                      rel="noopener noreferrer"
                                    >
                                      <div
                                      ...
                                      >
                                        <span className="symbol-label bg-danger text-inverse-info fw-bolder">
                                          Y
                                        </span>
                                      </div>
                                    </a>
