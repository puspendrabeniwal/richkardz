                      ...
                      <div class="product-wrap">
                        ...
                        <div class="product-textNew">
                          ...
                          <div class="row">
                            ...
                            <div class="col-6 text-end rattingCards">
                              <span class="rattingSpan">
                                {" "}
                                <span class="rattingText">★ 4.5</span>
                        ...
                        <div class="product-priceorbtn">
                          ...
                          <div class="product-buy-btn">
                            <button
                              class="defult-btn-all-black product-buy-now"
                              onclick="if (!window.__cfRLUnblockHandlers) return false; window.location.href='/combo-products/printing-details?product_id=Mw%3D%3D'"
                              data-pjax="0"
                              data-cf-modified-8ce08585acb10ccfe48dbab1-
                            >
                              {" "}
                              <i class="bi bi-arrow-right"></i> Buy Now
                            </button>
                          </div>
                        </div>
                      </div>
