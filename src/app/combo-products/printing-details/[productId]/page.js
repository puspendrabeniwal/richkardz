...
export default function DeliveryAddress({ params }) {
  ...
  const onSubmit = (values, { resetForm }) => {
    instance
      .post(
        `products/combo-printing-details?product_id=${params.productId}`,
        values
      )
      .then((response) => {
                ...
                <div className="accordion-item" key={index}>
                  <div className="accordion-header" id={`heading${index}`}>
                    <button
                      ...
                      aria-expanded={currentAccordionIndex === index}
                  ...
                  <div
                    ...
                    className={`accordion-collapse collapse ${
                      currentAccordionIndex === index ? "show" : ""
                    }`}
                          ...
                          <Formik
                            ...
                            validationSchema={Yup.object().shape({
                              ComboCardPrintingData: Yup.object().shape({
                                [COMBO_PRODUCTS_FIELDS_NAME[index] +
                                "_full_name"]: Yup.string().required(
                                ...
                                [COMBO_PRODUCTS_FIELDS_NAME[index] +
                                "_phone_number"]: Yup.string().required(
                                  "This field is required"
                                ),
                                [COMBO_PRODUCTS_FIELDS_NAME[index] +
                                "_designation"]: Yup.string().required(
                                  "This field is required"
                                ),
                              }),
                            })}
