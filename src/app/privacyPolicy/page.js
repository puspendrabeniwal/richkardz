      ...
      <body className="bodyMain">
        ...
        <section className="privacyPolicy pb-5">
          <div className="container">
            <h3 className="">
              Privacy Policy for BLUE ZONE ONLINE MARKETING SOLUTIONS PRIVATE
              LIMITED
            </h3>
            <p className="">
              At RichKardz, accessible from https://www.richkardz.com/, one of
              our main priorities is the privacy of our visitors. This Privacy
              Policy document contains types of information that is collected
              and recorded by RichKardz and how we use it. If you have
              ...
              collect in RichKardz. This policy is not applicable to any
              information collected offline or via channels other than this
              website.
            </p>
            <h3 className="">Consent</h3>
            <p className="">
            ...
            <h3>Log Files</h3>
            <p className="">
              RichKardz follows a standard procedure of using log files. These
            ...
            <p className="">
              Like any other website, RichKardz uses 'cookies'. These cookies
            ...
            <p className="">
              ...
              the advertising partners of RichKardz. Third-party ad servers or
              ...
              that appear on RichKardz, which are sent directly to users'
              ...
              <br />
              Note that RichKardz has no access to or control over these cookies
              that are used by third-party advertisers.
            </p>
            <h3>Third Party Privacy Policies</h3>
            <p>
              RichKardz's Privacy Policy does not apply to other advertisers or
            ...
            <p>
              ...
              activity. RichKardz does not knowingly collect any Personal
            ...
            <p>
              ...
              do not hesitate to contact us on support@richkardz.com.
            </p>
          </div>
        </section>
        <Footer />
