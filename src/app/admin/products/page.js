            ...
            <div className="toolbar" id="kt_toolbar">
                <div id="kt_toolbar_container" className="container-fluid d-flex flex-stack">
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" className="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                        ...
                        <span className="h-20px border-1 border-gray-200 border-start ms-3 mx-2 me-1">Product Management</span>
                ...
                <div className="d-flex align-items-center gap-2 gap-lg-3">
                                        ...
                                        <Form className="form-design">
                                                ...
                                                <div className="px-7 py-5">
                                                    ...
                                                    <div className="d-flex justify-content-end">
                                                        ...
                                                        <button type="button" onClick={removeFilter} className="btn btn-sm btn-danger" data-kt-menu-dismiss="true">Remove</button>
                                                    </div>
                                                </div>
                                        </Form>
                                    )}
                        ...
                        <Link href="/admin/products/add" className="btn btn-sm btn-info">Add Product</Link>
                    </div>
                </div>
            </div>
        </div>
