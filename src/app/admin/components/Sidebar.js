            ...
            >
              <div data-kt-menu-trigger="click" className="menu-item here show menu-accordion">
                ...
                <div className="menu-item">
                      <Link className="menu-link" href="/admin/products">
                    ...
                    <div className="menu-item">
                      <Link className="menu-link" href="/admin/comboProducts">
                        <span className="menu-bullet">
                          <span className="bullet bullet-dot"></span>
                        </span>
                        <span className="menu-title">Combo Products</span>
                      </Link>
                    </div>
                    <div className="menu-item">
                      <Link className="menu-link" href="/admin/gift-pre-design-products">
                        <span className="menu-bullet">
                          <span className="bullet bullet-dot"></span>
                        </span>
                        <span className="menu-title">Gift Pre Order Products</span>
                      </Link>
                    </div>
                </div>
              </div>
