...
const UpdateProduct = ({ params }) => {
  ...
  const getProductDetails = async () => {
    ...
    instance
      .post("gift_pre_design_product/view/" + params.productId, formData)
      .then((response) => {
                ...
                <div id="kt_toolbar_container" className="container-fluid d-flex flex-stack">
                    <div data-kt-swapper="true" data-kt-swapper-mode="prepend" data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" className="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                        ...
                        <ul className="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                            ...
                            <li className="breadcrumb-item text-dark">
                                <Link href="/admin/gift-pre-design-products" className="text-muted text-hover-primary">Gift Pre Design Product</Link>
                            </li>
                            <li className="breadcrumb-item">
                                <span className="bullet bg-gray-300 w-5px h-2px"></span>
                            </li>
                    ...
                    <div className="d-flex align-items-center gap-2 gap-lg-3">
                        <Link href="/admin/gift-pre-design-products" className="btn btn-sm btn-warning"><i className="pi pi-arrow-left"></i>Back</Link>
                    </div>
                </div>
            </div>
        </div>
